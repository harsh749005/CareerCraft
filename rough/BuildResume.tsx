...
// type BuildResumeProps = {
//   resumeId?: string;
// };

// export default function BuildReume({ resumeId }: BuildResumeProps) {
...
//   console.log("BuildResume resume_id",resume_id);
//   const { formDataDraft, updateSection, isSaving } = useFormDraft(userId ?? "", resume_id); 
//   // useFormDraft(userId ?? "", resume_id);
...
//     console.log("Resume ID is set:", value);
//     setFormData((prev) => ({ ...prev, resume_id: value }));
//   };

//   const setBranch = (branch: string) => {
//     updateSection("personal_info", {    // ✅ section key + new value
//       ...formDataDraft?.personal_info,
//       branch,
//     });
//   };
...
//       updateSection("selected_template", value);
//     };
//   // 🔹 Update Personal Info (nested object)
//   const updatePersonalInfo = (field: string, value: string) => {
//     updateSection("personal_info", {    //[field]: value ✅ section key + new value
//       ...formDataDraft?.personal_info,
//       [field]: value,
//     });
//   };
...
//     const updated = (formDataDraft?.education ?? []).map((exp, i) =>
//       i === index ? { ...exp, [field]: value } : exp
//     );
