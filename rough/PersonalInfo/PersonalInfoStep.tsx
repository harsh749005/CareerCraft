...
//   step: number;
//   totalSteps: number;
//   formDataDraft: ResumeDraft | null;
...
//   const filledCount = fields.filter((f) => !!formDataDraft?.personal_info[f.key]).length;
//   const progressPercent = Math.round((filledCount / fields.length) * 100);
//  console.log("formDraft",formDataDraft?.personal_info)
//   return (
...
//             const value = formDataDraft?.personal_info[key] || "";
...
//                     value={formDataDraft?.personal_info?.[key] ?? ""}
